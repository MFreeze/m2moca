...
\dfpb{Problème de Steiner}{$G = (V, E), M \subseteq V$ et une fonction de coût $E \mapsto
\mathbb{R}$}{$H = (V', E)$ avec $V' \subset V, E' \subset E, M \subset V'$.  Il s'agit d'un sous
graphe partiel connexe de $G$ qui minimise des contraintes.}
